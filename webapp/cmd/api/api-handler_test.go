...
func Test_app_authenticate(t *testing.T) {
	...
	var tests = []struct {
		...
		{name: "wrong password", requestBody: `{"username":"admin@example.com","password":"wrong"}`, expectedStatusCode: http.StatusUnauthorized},
		{name: "empty password", requestBody: `{"username":"admin@example.com","password":""}`, expectedStatusCode: http.StatusUnauthorized},
